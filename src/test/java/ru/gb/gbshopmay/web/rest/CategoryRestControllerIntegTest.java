...
class CategoryRestControllerIntegTest {
    ...
    private final String FIRST_TEST_CATEGORY = "Test1";
    private final String SECOND_TEST_CATEGORY = "Test2";
    ...
    public void findAllTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/category"))
                ...
                .andExpect(jsonPath("$.[0].title").value(FIRST_TEST_CATEGORY));
    }
}